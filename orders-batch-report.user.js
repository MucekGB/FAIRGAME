    ...
    `;
        ...
        function updateFromPage(isRetry = false) {
            try {
                ...
                // Fetch A&R (AR)
                const arTxt = onlineMap['AR'] || getItemsByLabel('mat-card:nth-child(16) app-section-card mat-table', ['AR'], null);
                values['A&R'] = safeTextToNumber(arTxt);
                ...
                // badge dla Actual Minus = BAZA z Actual (po Store)
                ...
                // Depot 33 (EVR - 33) search: find row containing EVR and 33 in likely tables
                ...
                // Apply Saturday conditional logic
                if (saturday) {
                    // Stated = Courier + Courier Sunday - Depot 33 - Sale
                ...
                if (saturday) {
                    // Saturday collation: Courier + Courier Sunday - Depot 33 - Sale
